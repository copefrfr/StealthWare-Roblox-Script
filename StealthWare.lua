SteathWare by Cope. © 2025

https://discord.gg/f5Wq8bdV
...
if StealthWareLoaded then return end
getgenv().StealthWareLoaded = true



getgenv().StealthWare = {}
getgenv().AirHub = getgenv().StealthWare
...
local ConfigsTab = MainFrame:CreateTab({
Name = "Configs"
})

local ConfigsSection = ConfigsTab:CreateSection({
Name = "Config Manager"
})
...
Name = "Save Config",
Callback = function()
	if getgenv().CurrentConfigName then
		...
		writefile("C:/StealthWare/Configs/" .. getgenv().CurrentConfigName .. ".txt", data)
	end
end
})
...
Name = "Load Config",
Callback = function()
	if getgenv().CurrentConfigName and isfile("C:/StealthWare/Configs/" .. getgenv().CurrentConfigName .. ".txt") then
		local raw = readfile("C:/StealthWare/Configs/" .. getgenv().CurrentConfigName .. ".txt")
		local decoded = HttpService:JSONDecode(raw)

		Aimbot.Settings = decoded.Aimbot or Aimbot.Settings
		Visuals.Settings = decoded.Visuals or Visuals.Settings
		Crosshair.Settings = decoded.Crosshair or Crosshair.Settings
		Functions.Settings = decoded.Functions or Functions.Settings
	end
end
})
...
Callback = function()
	if getgenv().CurrentConfigName and isfile("C:/StealthWare/Configs/" .. getgenv().CurrentConfigName .. ".txt") then
		delfile("C:/StealthWare/Configs/" .. getgenv().CurrentConfigName .. ".txt")
	end
end
})

local function RefreshConfigs()
local Files = listfiles("C:/StealthWare/Configs/")
local ConfigNames = {}

for i, v in ipairs(Files) do
	local Name = v:match("([^/\\]+)%.txt$")
	if Name then
...
Name = "Join Discord!!",
Callback = function()
	setclipboard("https://discord.gg/f5Wq8bdV")
	game.StarterGui:SetCore("SendNotification", {
		Title = "StealthWare",
		Text = "Discord link copied to clipboard!",
		Icon = "rbxassetid://99009449623679",
		Duration = 5,
	})
end
})
...
local ConfigFolder = "C:/StealthWare/Configs/"

if not isfolder("C:/StealthWare") then
makefolder("C:/StealthWare")
end
...
local ConfigsSection = FunctionsTab:CreateSection({
Name = "Configs"
})
...
Callback = function()
	if getgenv().CurrentConfigName then
		local data = "example_settings=true"
		writefile(ConfigFolder .. getgenv().CurrentConfigName .. ".txt", data)
	end
end
})
...
Name = "Load Config",
Callback = function()
	if getgenv().CurrentConfigName and isfile(ConfigFolder .. getgenv().CurrentConfigName .. ".txt") then
		local data = readfile(ConfigFolder .. getgenv().CurrentConfigName .. ".txt")
	end
end
})
...
Callback = function()
	if getgenv().CurrentConfigName and isfile(ConfigFolder .. getgenv().CurrentConfigName .. ".txt") then
		delfile(ConfigFolder .. getgenv().CurrentConfigName .. ".txt")
	end
end
})
